...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements ts.HelloWorldService {
    ...
    public ts.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public ts.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ts.HelloWorldSoapBindingStub _stub = new ts.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ts.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ts.HelloWorldSoapBindingStub _stub = new ts.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
